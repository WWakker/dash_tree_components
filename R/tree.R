...
tree <- function(id=NULL, aria_label=NULL, className=NULL, collapse_icon_color=NULL, data=NULL, height=NULL, indent=NULL, node_icon_color=NULL, open_by_default=NULL, padding=NULL, padding_bottom=NULL, padding_top=NULL, rowClassName=NULL, row_height=NULL, search_input_height=NULL, searchable=NULL, selected_id=NULL, width=NULL) {
    ...
    component <- list(
        ...
        propNames = c('id', 'aria_label', 'className', 'collapse_icon_color', 'data', 'height', 'indent', 'node_icon_color', 'open_by_default', 'padding', 'padding_bottom', 'padding_top', 'rowClassName', 'row_height', 'search_input_height', 'searchable', 'selected_id', 'width'),
